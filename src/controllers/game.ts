...
export default class Game {
    ...
    public sendDevInfo($user: User) {
        if (this.accessControl.hasPermission($user, "SUPERUSER")) {
            Messenger.sendSuccessMessage(this.room, "Pokedex v" + this.config.Version + " Support Mode: ON!", this.config.Dev);
        } else {
            Messenger.sendErrorMessage(this.room, "Pokedex v" + this.config.Version + " Support Mode: OFF!", this.config.Dev);
        }
    }

    public sendWelcomeMessage($user: User) {
        if (!this.trainerManager.PokemonTrainers.has($user.username)) {
            Messenger.sendWelcomeMessage(this.room, $user.username);
    ...
    public handleCommands($message: Message, $user: User): Message {
        ...
        switch (command) {
            case this.config.CMDS.RELEASE: {
                try {
                    if (this.trainerManager.PokemonTrainers.has($user.username)) {
                        Messenger.sendInfoMessage(this.room, `You wave goodbye to your level ${this.trainerManager.PokemonTrainers.get($user.username)!.Pokemon.Level} ${this.trainerManager.PokemonTrainers.get($user.username)!.Pokemon.Name} as it scurries freely into the wild!`, $user.username);
                ...
                if (this.trainerManager.PokemonTrainers.has($user.username) && this.trainerManager.PokemonTrainers.get($user.username)!.Pokemon.UsesStone) {
                    if (this.trainerManager.PokemonTrainers.get($user.username)!.BuyStoneWarning === true) {
                        if ($user.username === this.room.owner) {
                            ...
                            Messenger.sendInfoMessage(this.room, "Okay, your next tip of " + this.settings.stone_price + " tokens will buy you a " + this.trainerManager.PokemonTrainers.get($user.username)!.Pokemon.Types[0].Stone, $user.username);
                            this.trainerManager.PokemonTrainers.get($user.username)!.BuyStoneConfirmation = true;
                        }
                    } else {
                        Messenger.sendInfoMessage(this.room, "Are you sure you want to purchase a " + this.trainerManager.PokemonTrainers.get($user.username)!.Pokemon.Types[0].Stone + "? It costs " + this.settings.stone_price + " tokens to purchase a stone. Type '/buystone' again to allow your next tip of " + this.settings.stone_price + " tokens to buy a " + this.trainerManager.PokemonTrainers.get($user.username)!.Pokemon.Types[0].Stone, $user.username);
                    ...
                    if (this.trainerManager.PokemonTrainers.has($user.username)) {
                        if ($user.username === targetUser) {
                            ...
                            if (leftHP <= 0) {
                                ...
                                Messenger.sendInfoMessage(this.room, `You wave goodbye to your level ${this.trainerManager.PokemonTrainers.get(targetUser)!.Pokemon.Level} ${this.trainerManager.PokemonTrainers.get(targetUser)!.Pokemon.Name} as it scurries freely into the wild!`, targetUser);
            ...
            case "debugpkm": {
                this.trainerManager.PokemonTrainers.forEach((trainer) => Messenger.sendInfoMessage(this.room, customStringify(trainer), $user.username));
                break;
            }
        }
    ...
    public levelUp($user: User, $tip: Tip) {
        if (this.trainerManager.PokemonTrainers.has($user.username)) {
            ...
            this.trainerManager.LevelUpPokemonOfUser($user.username, Math.floor($tip.tokens / this.settings.level_pokemon));
        }
    }
    ...
    private initBroadcaster($room: Room) {
        ...
        if (this.settings.elite_four_1 !== undefined && this.settings.elite_four_1.length > 0 && this.settings.elite_four_1_pokemon !== 0) {
            this.trainerManager.AddPokemonToTrainer(this.settings.elite_four_1_pokemon, this.settings.elite_four_1, 0);
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_1)!.Pokemon.Level = 100;
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_1)!.Pokemon.updateStats();
        }
        if (this.settings.elite_four_2 !== undefined && this.settings.elite_four_2.length > 0 && this.settings.elite_four_2_pokemon !== 0) {
            this.trainerManager.AddPokemonToTrainer(this.settings.elite_four_2_pokemon, this.settings.elite_four_2, 0);
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_2)!.Pokemon.Level = 100;
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_2)!.Pokemon.updateStats();
        }
        if (this.settings.elite_four_3 !== undefined && this.settings.elite_four_3.length > 0 && this.settings.elite_four_3_pokemon !== 0) {
            this.trainerManager.AddPokemonToTrainer(this.settings.elite_four_3_pokemon, this.settings.elite_four_3, 0);
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_3)!.Pokemon.Level = 100;
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_3)!.Pokemon.updateStats();
        }
        if (this.settings.elite_four_4 !== undefined && this.settings.elite_four_4.length > 0 && this.settings.elite_four_4_pokemon !== 0) {
            this.trainerManager.AddPokemonToTrainer(this.settings.elite_four_4_pokemon, this.settings.elite_four_4, 0);
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_4)!.Pokemon.Level = 100;
            this.trainerManager.PokemonTrainers.get(this.settings.elite_four_4)!.Pokemon.updateStats();
        }
    }
    //#endregion
